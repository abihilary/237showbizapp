...
class Instrumental extends StatefulWidget {
  ...
  @override
  State<Instrumental> createState() => _HomeState();
}

class _HomeState extends State<Instrumental> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // bottomNavigationBar:BottomNav(externalSearchFunction: ()=>{},isDarkMode: isDarkMode),
    );
  }
}
